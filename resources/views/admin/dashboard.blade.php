<x-app-layout>
    <div class="min-h-screen p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-8">
            <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center hover:shadow-md transition">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <img src="{{ $contributor->avatar ? asset('storage/' . $contributor->avatar) : asset('default-avatar.png') }}" 
