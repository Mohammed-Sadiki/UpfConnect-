<x-app-layout>
    <!-- Post Creation Card -->
    <div class="bg-white rounded-xl p-5 shadow-md border border-gray-200 mb-6 hover:shadow-lg transition-shadow">
        <div class="flex space-x-3">
            <img class="h-12 w-12 rounded-full object-cover flex-shrink-0 ring-2 ring-gray-200"
            ...
            <button onclick="document.getElementById('post-modal').classList.remove('hidden')"
                    class="flex-1 text-left bg-gray-50 hover:bg-gray-100 transition rounded-full px-5 py-3 text-sm text-gray-600 font-medium border border-gray-200">
                Commencer un post...
            </button>
        </div>
        <div class="flex justify-around mt-4 pt-3 border-t border-gray-200">
            <button onclick="document.getElementById('post-modal').classList.remove('hidden')"
                    class="flex items-center space-x-2 text-gray-600 hover:bg-gray-100 px-4 py-2 rounded-lg transition text-sm font-semibold">
                <svg class="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clip-rule="evenodd"></path></svg>
                <span>Média</span>
            </button>
            <a href="{{ route('events.index') }}"
               class="flex items-center space-x-2 text-gray-600 hover:bg-gray-100 px-4 py-2 rounded-lg transition text-sm font-semibold">
                <svg class="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
                <span>Événement</span>
            </a>
        </div>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow border border-gray-200">
            <div class="p-5">
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg ring-1 ring-black/10 z-10">
            ...
            <!-- Comments Section -->
            <div id="comments-{{ $post->id }}" class="hidden border-t border-gray-200 bg-gray-50">
                <div class="px-4 pt-3 pb-2">
                    <form action="{{ route('posts.comment', $post) }}" method="POST" class="flex space-x-2">
                        ...
                        <input type="text" name="content" required placeholder="Ajouter un commentaire..."
                               class="flex-1 bg-white border border-gray-200 text-gray-800 rounded-full px-4 text-sm focus:outline-none focus:border-blue-500">
                ...
                <div class="px-4 pb-4 space-y-3">
                    ...
                    <div class="flex space-x-2">
                        <img class="h-8 w-8 rounded-full object-cover flex-shrink-0 mt-1"
                             ...
                             alt="">
                        <div class="bg-white border border-gray-200 px-3 py-2 rounded-2xl flex-1">
        ...
        @empty
        <div class="bg-white rounded-xl p-10 text-center text-gray-500 shadow-md border border-gray-200">
            <svg class="w-16 h-16 mx-auto text-gray-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
            <p class="font-medium text-lg text-gray-900">Votre fil est vide</p>
    ...
    <div class="bg-white rounded-xl p-6 shadow-md mt-6 border border-gray-200">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition border border-gray-100">
                <div class="flex items-center space-x-3">
                    <div class="relative">
            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="p-5">
                ...
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <select name="visibility" class="rounded-full border border-gray-300 bg-white px-3 py-1 text-xs font-medium text-gray-800 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20">
